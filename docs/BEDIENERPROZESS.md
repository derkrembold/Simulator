...
| Rpe (Ω)                            | Ja                      | RLOW-Messung PE-Durchgang                  | In der Regel wird die Messung von der Steckdose, Anschlussdose oder Drehstromsteckdose zur PE Klemme geführt. Das muss man machen! Vor RLOW (wie vor RISO) die Anlage spannungsfrei machen (Hauptschalter aus, oder betroffene Schrauben auf).                     |
| Riso (MΩ)<br>Verbraucher ohne      | Ja                      | RISO-Messung, Verbraucher abgeklemmt       | Beim Abklemmen, immer den Schraubendreher und Schraube verwenden. Nicht den RCD, oder AFDD Hebel. Ausnahme: Der Hauptschalter muss ausgeschaltet sein! Vor RISO grundsätzlich die Anlage spannungsfrei machen (Hauptschalter aus, oder betroffene Schrauben auf). Bei AFDD und RCD Typ B zusätzlich deren Schrauben aufdrehen, um den inneren (elektronischen) Widerstand zu umgehen - gilt auch hier: wenn Schrauben auf, dann auch spannungsfrei. |
